...
/**
 * Possible values for [OverlappingPanels] to indicate the current state of the
 */
...
public fun OverlappingPanels(
    ...
    //convert parameter implicitly
    val resource = LocalContext.current.resources
    val layoutDirection = LocalLayoutDirection.current

    //one super large self-defined box
    BoxWithConstraints(modifier.fillMaxSize()) {
        val fraction =
            // the direction of your screen
        ...
        val offsetValue =
            // constraints from parent layout
            (constraints.maxHeight * fraction) + PanelDefaults.MarginBetweenPanels.value
